...
/*
  ...
  Поэтому оба органа управления - нативные select, вшитые прямо в строку и
  подчёркнутые той же охряной чертой, что и остальные выделения в тексте.
...
export function Estimate() {
  ...
  */
  const Field = ({
    ...
    <span className="stroke relative inline-block align-baseline">
