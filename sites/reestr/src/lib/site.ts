...
export const SITE = {
  ...
  description:
    "Реестр проектов, продвигаемых поведенческими сигналами в Яндексе: домен, запросы, позиции до и после, дата записи. Опубликованы и те записи, по которым роста не случилось. Оплата за фактические переходы, остановка в течение часа.",
