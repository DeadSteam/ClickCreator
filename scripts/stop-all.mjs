/*
  ...
  Скрипт трогает только слушателей на портах репозитория и только процессы,
  в командной строке которых есть его путь. Чужой сервер на 3000, запущенный
  для другого проекта, останется жив.
*/
